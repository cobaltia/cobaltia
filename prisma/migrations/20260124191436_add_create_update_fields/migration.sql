...
*/
-- DropIndex
DROP INDEX "inventories_user_id_item_id_key";

-- AlterTable
ALTER TABLE "bank_transactions" ADD COLUMN     "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- AlterTable
ALTER TABLE "voices" ADD COLUMN     "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "updated_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;
